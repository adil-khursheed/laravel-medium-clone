...
<div x-data="{
    ...
    }" class="mt-10 border-t border-b border-gray-200 py-5 px-4">
    <button @click="clap()" class="size-7 text-gray-500 hover:text-gray-800 cursor-pointer flex items-center gap-3">
